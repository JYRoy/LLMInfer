...
class Model {
 public:
  ...
  virtual tensor::Tensor fill_input(
      const tensor::Tensor& pos_tensor,
      const op::EmbeddingOutput& embedding_output,
      bool is_prompt) const;

 protected:
  virtual base::Status insert_buffer(
  ...
  virtual int32_t post_processing(const tensor::Tensor& pos, bool is_prompt)
      const = 0;
